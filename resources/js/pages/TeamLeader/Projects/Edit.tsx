...
export default function ProjectEdit({ project, owners }: any) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Edit', href: `/leader/projects/${project.id}/edit` },
    ];
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(`/leader/projects/${project.id}`, {
                    ...
                    <CardHeader className="bg-muted/10 pb-8 px-8 border-b">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <CardDescription className="text-base mt-1">Update details for {project.name}</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
