...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: '/leader/projects/create' },
];

export default function ProjectCreate({ owners }: any) {
    const { data, setData, post, processing, errors } = useForm({
        name: '',
        description: '',
        status: 'pending',
        owner_id: String(owners[0]?.id || ''), // Auto-assigned to leader
        start_date: '',
        end_date: '',
    });
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post('/leader/projects', {
            onError: () => toast.error("Please fix the errors in the form.", { className: "bg-red-50 text-red-600" }),
        });
    };
                ...
                <Card className="border-t-4 border-t-primary shadow-lg w-full">
                    <CardHeader className="bg-muted/10 pb-8 px-8 border-b">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <CardDescription className="text-base mt-1">Define project scope and timeline.</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                    ...
                    <form onSubmit={submit}>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        {/* Disabled because it is auto-assigned to the leader */}
                                        <Select value={data.owner_id} disabled>
                                            <SelectTrigger className="h-12 text-base bg-muted/50"><SelectValue /></SelectTrigger>
                                            <SelectContent>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Textarea id="description" className="text-base resize-none" value={data.description} onChange={(e) => setData('description', e.target.value)} rows={4} />
                        ...
                        <CardFooter className="flex justify-end gap-4 py-6 px-8 bg-muted/5 border-t">
                            <Button variant="outline" size="lg" className="h-12 px-6" asChild><Link href="/leader/projects">Cancel</Link></Button>
