...
export default function SprintCreate({ projects }: any) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Create', href: '/admin/sprints/create' },
    ];
                    ...
                    <form onSubmit={submit}>
                        <CardContent className="space-y-10 p-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        ...
                                        <Input id="name" className="h-12 text-base" value={data.name} onChange={(e) => setData('name', e.target.value)} placeholder="e.g. Sprint 1 - MVP Setup" autoFocus />
                            ...
                            <div className="space-y-3">
                                ...
                                <Textarea id="goal" className="text-base resize-y" value={data.goal} onChange={(e) => setData('goal', e.target.value)} rows={4} placeholder="What is the primary objective of this sprint?" />
