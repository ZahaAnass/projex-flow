    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="max-w-5xl mx-auto p-6 space-y-6 w-full">
                <Link href="/admin/tasks" className="inline-flex items-center text-sm font-medium text-muted-foreground hover:text-primary transition-colors">
                ...
                <Card className="border-t-4 border-t-primary shadow-lg w-full">
                    <CardHeader className="bg-muted/10 pb-8 px-8 border-b">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <CardDescription className="text-base mt-1">Add a new deliverable, bug, or user story.</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                    ...
                    <form onSubmit={submit}>
                        <CardContent className="space-y-10 p-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Input id="title" className="h-12 text-base" value={data.title} onChange={(e) => setData('title', e.target.value)} autoFocus />
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Select value={data.sprint_id} onValueChange={(val) => setData('sprint_id', val)} disabled={!data.project_id}>
                                            <SelectTrigger className="h-12 text-base"><SelectValue placeholder="Select sprint or leave as Backlog" /></SelectTrigger>
                                            <SelectContent>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                    <div className="space-y-3">
                                        ...
                                        <Select value={data.type} onValueChange={(val) => setData('type', val)}>
                                            ...
                                            <SelectContent>
                                                <SelectItem value="task" className="text-base">Task</SelectItem>
                                                <SelectItem value="bug" className="text-base text-red-600">Bug</SelectItem>
                                                <SelectItem value="story" className="text-base text-blue-600">User Story</SelectItem>
                                            </SelectContent>
                                        </Select>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Select value={data.priority} onValueChange={(val) => setData('priority', val)}>
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value="urgent" className="text-base font-bold text-red-600">Urgent</SelectItem>
                                            </SelectContent>
                                        </Select>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                    <div className="space-y-3">
                                        ...
                                        <Select value={data.status} onValueChange={(val) => setData('status', val)}>
                                            <SelectTrigger className="h-12 text-base"><SelectValue /></SelectTrigger>
                                            <SelectContent>
                                                <SelectItem value="todo" className="text-base">To Do</SelectItem>
                                    ...
                                    <div className="space-y-3">
                                        <Label htmlFor="estimated_hours" className="text-base">Estimated Hours</Label>
                                        <Input id="estimated_hours" type="number" min="0" className="h-12 text-base" value={data.estimated_hours} onChange={(e) => setData('estimated_hours', e.target.value)} placeholder="e.g. 5" />
                                        <InputError message={errors.estimated_hours} />
                                    </div>
                                    <div className="space-y-3">
                                        <Label htmlFor="due_date" className="text-base">Due Date</Label>
                                        <Input id="due_date" type="date" className="h-12 text-base" value={data.due_date} onChange={(e) => setData('due_date', e.target.value)} />
                                        <InputError message={errors.due_date} />
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    <Label htmlFor="description" className="text-base">Description</Label>
                                    <Textarea id="description" className="text-base resize-y" value={data.description} onChange={(e) => setData('description', e.target.value)} rows={5} placeholder="Provide details, acceptance criteria, etc." />
                        ...
                        <CardFooter className="flex justify-end gap-4 py-6 px-8 bg-muted/5 border-t">
                            <Button variant="outline" size="lg" className="h-12 px-6" asChild><Link href="/admin/tasks">Cancel</Link></Button>
                            <Button type="submit" size="lg" disabled={processing} className="h-12 px-8">
                                {processing ? 'Saving...' : <><Save className="mr-2 h-5 w-5" /> Save Task</>}
                            </Button>
                        </CardFooter>
                    </form>
                </Card>
