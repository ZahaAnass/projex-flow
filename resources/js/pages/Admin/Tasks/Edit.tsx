                    ...
                    <CardHeader className="bg-muted/10 pb-8 px-8 border-b">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <CardDescription className="text-base mt-1">Update details and status for this item.</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                        ...
                        <CardContent className="space-y-10 p-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Input id="title" className="h-12 text-base" value={data.title} onChange={(e) => setData('title', e.target.value)} />
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Input id="estimated_hours" type="number" min="0" className="h-12 text-base" value={data.estimated_hours} onChange={(e) => setData('estimated_hours', e.target.value)} />
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Textarea id="description" className="text-base resize-y" value={data.description} onChange={(e) => setData('description', e.target.value)} rows={5} />
